      ...
      <div className="privacy-content">
        ...
        <div className="privacy-section">
          ...
          <ul>
            ...
            <li>
              Use Echoes. Echoes is a private shared scrapbook for the people you love. Create scrapbooks, invite your people and upload memories together in real time. Set time capsules, write letters to your future self and print your scrapbook as a beautiful hardcover book shipped anywhere in the world.
            </li>
        ...
        {/* SUMMARY */}
        <div className="privacy-section" id="summary">
          ...
          <p>
            ...
            <a href="#toc"><strong><em>table of contents</em></strong></a>
          ...
          <p>
            <strong>How do we keep your information safe?</strong> We have adequate organisational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorised third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about <a href="#infosafe">how we keep your information safe</a>.
          </p>
          <p>
          ...
          <p>
            ...
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
          </p>
          <p>
        ...
        {/* SECTION 1 */}
        <div className="privacy-section" id="infocollect">
          ...
          <p>
            ...
            <a href="https://paystack.com/privacy/merchant" target="_blank" rel="noopener noreferrer">
        ...
        {/* SECTION 2 */}
        <div className="privacy-section" id="infouse">
        ...
        {/* SECTION 3 */}
        <div className="privacy-section" id="legalbases">
        ...
        {/* SECTION 4 */}
        <div className="privacy-section" id="whoshare">
        ...
        {/* SECTION 5 */}
        <div className="privacy-section" id="sociallogins">
        ...
        {/* SECTION 6 */}
        <div className="privacy-section" id="intltransfers">
          ...
          <p>
            Our servers are located in the United States and Nigeria. Regardless of your location, please be aware that your information may be transferred to, stored by, and processed by us in our facilities and in the facilities of the third parties with whom we may share your personal information (see '<a href="#whoshare">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a>' above), including facilities in the United States, and other countries.
          </p>
          <p>
        ...
        {/* SECTION 7 */}
        <div className="privacy-section" id="inforetain">
        ...
        {/* SECTION 8 */}
        <div className="privacy-section" id="infosafe">
        ...
        {/* SECTION 9 */}
        <div className="privacy-section" id="infominors">
        ...
        {/* SECTION 10 */}
        <div className="privacy-section" id="privacyrights">
          ...
          <p>
            ...
            <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm" target="_blank" rel="noopener noreferrer">Member State data protection authority</a> or{" "}
            <a href="https://ico.org.uk/make-a-complaint/data-protection-complaints/data-protection-complaints/" target="_blank" rel="noopener noreferrer">UK data protection authority</a>.
          </p>
          <p>
            If you are located in Switzerland, you may contact the{" "}
            <a href="https://www.edoeb.admin.ch/edoeb/en/home.html" target="_blank" rel="noopener noreferrer">Federal Data Protection and Information Commissioner</a>.
          </p>
        ...
        {/* SECTION 11 */}
        <div className="privacy-section" id="DNT">
        ...
        {/* SECTION 12 */}
        <div className="privacy-section" id="uslaws">
          ...
          <p>
            ...
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a>, by emailing us at{" "}
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a>, or by referring to the contact details at the bottom of this document.
          </p>
          <p>
          ...
          <p>
            ...
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.
          </p>
        ...
        {/* SECTION 13 */}
        <div className="privacy-section" id="otherlaws">
          ...
          <p>
            At any time, you have the right to request access to or correction of your personal information. You can make such a request by contacting us by using the contact details provided in the section '<a href="#request">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a>'
          </p>
          ...
          <p>
            <a href="https://inforegulator.org.za/" target="_blank" rel="noopener noreferrer">The Information Regulator (South Africa)</a><br />
        ...
        {/* SECTION 14 */}
        <div className="privacy-section" id="policyupdates">
        ...
        <div className="privacy-section" id="contact">
          ...
          <p>
            ...
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a> or contact us by post at:
          </p>
          <p>
            Shonaike Temitayo<br />
            9, Apostle Afinjuomo Street<br />
            Mile 12, Lagos 100247<br />
            Nigeria
          </p>
        </div>
        ...
        {/* SECTION 16 */}
        <div className="privacy-section" id="request">
