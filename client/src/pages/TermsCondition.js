  ...
  return (
    <div className="privacy-container">
      <div className="privacy-content">
        ...
        <p className="privacy-date">Last updated June 17, 2026</p>

        {/* Intro */}
        <div className="privacy-section">
          <h2>AGREEMENT TO OUR LEGAL TERMS</h2>
          <p>
            We are Shonaike Temitayo, doing business as Echoes ('<strong>Company</strong>', '<strong>we</strong>', '<strong>us</strong>', or '<strong>our</strong>'), a company registered in Nigeria at 9, Apostle Afinjuomo Street, Mile 12, Lagos 100247.
          </p>
          <p>
            We operate the website{" "}
            <a href="https://www.echoesmemo.xyz" target="_blank" rel="noopener noreferrer">
              https://www.echoesmemo.xyz
            </a>{" "}
          ...
          <p>
            Echoes is a private shared scrapbook for the people you love. Create scrapbooks, invite your people and upload memories together in real time. Set time capsules, write letters to your future self and print your scrapbook as a beautiful hardcover book shipped anywhere in the world.
          </p>
          <p>
            You can contact us by email at{" "}
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a>{" "}
            or by mail to 9, Apostle Afinjuomo Street, Mile 12, Lagos 100247, Nigeria.
          </p>
          <p>
            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('<strong>you</strong>'), and Shonaike Temitayo, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
          </p>
          <p>
            ...
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
          </p>
          <p>
        ...
        {/* TABLE OF CONTENTS */}
        <div className="privacy-section" id="toc">
        ...
        {/* SECTION 1 */}
        <div className="privacy-section" id="services">
        ...
        {/* SECTION 2 */}
        <div className="privacy-section" id="ip">
          ...
          <p>
            ...
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
          </p>
          ...
          <p>
            We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the '<a href="#copyrightyes">COPYRIGHT INFRINGEMENTS</a>' section below.
          </p>
        </div>
        ...
        {/* SECTION 3 */}
        <div className="privacy-section" id="userreps">
        ...
        {/* SECTION 4 */}
        <div className="privacy-section" id="userreg">
        ...
        {/* SECTION 5 */}
        <div className="privacy-section" id="purchases">
        ...
        {/* SECTION 6 */}
        <div className="privacy-section" id="subscriptions">
          ...
          <h3>Cancellation</h3>
          <p>
            You can cancel your subscription at any time by contacting us using the contact information provided below. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at{" "}
            <a href="mailto:echoesmemo.noreply@gmail.com">echoesmemo.noreply@gmail.com</a>.
          </p>
          <h3>Fee Changes</h3>
          <p>
        ...
        {/* SECTION 7 */}
        <div className="privacy-section" id="software">
          <h2>7. SOFTWARE</h2>
          <p>
        ...
        {/* SECTION 8 */}
        <div className="privacy-section" id="prohibited">
        ...
        {/* SECTION 9 */}
        <div className="privacy-section" id="ugc">
        ...
        {/* SECTION 10 */}
        <div className="privacy-section" id="license">
        ...
        {/* SECTION 11 */}
        <div className="privacy-section" id="thirdparty">
        ...
        {/* SECTION 12 */}
        <div className="privacy-section" id="sitemanage">
        ...
        {/* SECTION 13 */}
        <div className="privacy-section" id="ppyes">
          <h2>13. PRIVACY POLICY</h2>
          <p>
            We care about data privacy and security. Please review our Privacy Policy:{" "}
            <a href="https://echoesmemo.xyz/privacy" target="_blank" rel="noopener noreferrer">
              https://echoesmemo.xyz/privacy
            </a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.
          </p>
        </div>
        ...
        {/* SECTION 14 */}
        <div className="privacy-section" id="copyrightyes">
        ...
        {/* SECTION 15 */}
        <div className="privacy-section" id="terms">
        ...
        {/* SECTION 16 */}
        <div className="privacy-section" id="modifications">
        ...
        {/* SECTION 17 */}
        <div className="privacy-section" id="law">
          <h2>17. GOVERNING LAW</h2>
          <p>
            These Legal Terms shall be governed by and defined following the laws of Nigeria. Shonaike Temitayo and yourself irrevocably consent that the courts of Nigeria shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
          </p>
        </div>
        ...
        {/* SECTION 18 */}
        <div className="privacy-section" id="disputes">
          ...
          <p>
            If the parties are unable to resolve the dispute through informal negotiation, the dispute shall be finally resolved by arbitration in accordance with the United Nations Commission on International Trade Law Arbitration Rules in force at the time of commencement of the arbitration. The number of arbitrators shall be one (1). The seat, or legal place, or arbitration shall be Lagos, Nigeria. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of Nigeria.
          </p>
          <h3>Restrictions</h3>
          <p>
        ...
        {/* SECTION 19 */}
        <div className="privacy-section" id="corrections">
        ...
        {/* SECTION 20 */}
        <div className="privacy-section" id="disclaimer">
          <h2>20. DISCLAIMER</h2>
          <p>
        ...
        {/* SECTION 21 */}
        <div className="privacy-section" id="liability">
        ...
        {/* SECTION 22 */}
        <div className="privacy-section" id="indemnification">
        ...
        {/* SECTION 23 */}
        <div className="privacy-section" id="userdata">
          <h2>23. USER DATA</h2>
          <p>
        ...
        {/* SECTION 24 */}
        <div className="privacy-section" id="electronic">
        ...
        {/* SECTION 25 */}
        <div className="privacy-section" id="california">
        ...
        {/* SECTION 26 */}
        <div className="privacy-section" id="misc">
        ...
        <div className="privacy-section" id="contact">
          ...
          <p>
            <strong>Shonaike Temitayo</strong><br />
            <strong>9, Apostle Afinjuomo Street</strong><br />
            <strong>Mile 12, Lagos 100247</strong><br />
            <strong>Nigeria</strong><br />
            <a href="mailto:echoesmemo.noreply@gmail.com"><strong>echoesmemo.noreply@gmail.com</strong></a>
          </p>
        </div>
      ...
      <footer className="privacy-footer">
        <p>© {new Date().getFullYear()} Shonaike Temitayo (Echoes). All rights reserved.</p>
      </footer>
    </div>
  );
}